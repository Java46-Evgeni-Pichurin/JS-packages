...
function selectTitle(id, title){
    document.getElementById(id).innerHTML += `<option value="${title}" selected>${title}</option>`;
}
selectTitle(`course-name-options`, `--Select course name--`);
selectTitle(`lecturer-options`, `--Select lecture name--`);